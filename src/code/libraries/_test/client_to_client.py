...
from packages.client_to_client import from_client_to_client_upsert
from utils import runtime, path_config
...
if __name__ == "__main__":
    path = path_config.RUNTINE_PATH / "gamma" / "client_to_client" / "runtime" / "users_runtime_def.json"
