...
if __name__ == "__main__":
    ...
    RUNTIME_BASE = CURRENT_DIR.parent / "runtime_definitions" / "gamma" / "client_to_csv" / "runtime"
    runner_module = os.getenv("RUNNER_MODULE", "libraries.runners.client_to_csv")
    runtime_files_env = os.getenv("RUNTIME_FILES", "users.json")
