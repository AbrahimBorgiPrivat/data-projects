...
$modelPath = ".\src\workspace-serve\airport\SemanticModel\Airport Passenger Flight Insights (Power BI Demo).SemanticModel\definition\model.tmdl"
...
$scriptsBase = ".\src\workspace-serve\airport\Tabular"
$scripts = @(
    # MEASURES
