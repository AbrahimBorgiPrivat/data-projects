...
var measureList = new List<string[]> {
    ...
    new[] { "FORECAST - W.O. FILTER",
            System.IO.File.ReadAllText(System.IO.Path.Combine(basePath, "FORECAST - W.O. FILTER.dax")),
            "KPI \\ FC", "",MeasureBuilder.FormatStrings["danish_currency"],"true" },
    new[] { "FORECAST - BU",
            System.IO.File.ReadAllText(System.IO.Path.Combine(basePath, "FORECAST - BU.dax")),
            "KPI \\ FC", "",MeasureBuilder.FormatStrings["danish_currency"],"true" },
    new[] { "FORECAST - NOT BU",
