...
This folder contains the scripts and helper library used to automate and manage the Tabular model for the **GamMa - Reporting** project.
...
Tabular/
│
├─ Classes/                    # Source .csx utility scripts (legacy)
├─ Measures/                   # Folder containing KPI and DAX measure scripts
│   └─ KPI/
│       ├─ KPI_MEASURES.csx
│       └─ REALISERET.dax
│
