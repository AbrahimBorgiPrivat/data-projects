    ...
    public static class RelationshipBuilder
    {
            ...
            bool isActive)
        {
            ...
            foreach (var r in relationships)
            {
                try
                {
                    var fromName = r.FromColumn.Table.Name + "." + r.FromColumn.Name;
                    var toName   = r.ToColumn.Table.Name   + "." + r.ToColumn.Name;

                    bool sameDirection = fromName == (fromTableName + "." + fromColumnName) &&
                                         toName   == (toTableName + "." + toColumnName);

                    bool oppositeDirection = fromName == (toTableName + "." + toColumnName) &&
                                             toName   == (fromTableName + "." + fromColumnName);
